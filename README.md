...
- `scripts/02综合评价与权重方法/`: 综合评价与权重计算方法
- `scripts/03预测回归与拟合方法/`: 后续第三类模型与分析脚本
- `scripts/04优化规划方法/`: 后续第四类模型与分析脚本
- `scripts/05聚类与分类方法/`: 后续第五类模型与分析脚本
...
- `scripts/02综合评价与权重方法/层次分析法全过程.py`: AHP 层次分析法权重计算、一致性检验与方案评分模板
- `scripts/02综合评价与权重方法/熵权法全过程.py`: 熵权法正向化、归一化、权重计算与综合评分模板
- `scripts/02综合评价与权重方法/TOPSIS排序全过程.py`: TOPSIS 正负理想解、贴近度计算与方案排序模板
- `scripts/02综合评价与权重方法/熵权法加TOPSIS全过程.py`: 熵权法自动赋权与 TOPSIS 综合排序模板
- `scripts/03预测回归与拟合方法/多元线性回归全过程.py`: 多元线性回归系数、R2、p值与残差诊断图模板
- `scripts/03预测回归与拟合方法/GM11灰色预测全过程.py`: GM(1,1) 灰色预测、级比检验、误差评价与预测图模板
- `scripts/03预测回归与拟合方法/插值与最小二乘拟合全过程.py`: 一维插值、多项式最小二乘、非线性最小二乘拟合模板
- `scripts/04优化规划方法/线性规划全过程.py`: 线性规划建模、求解、目标值与约束松弛量分析模板
- `scripts/04优化规划方法/整数规划与01规划全过程.py`: 整数规划与0-1规划建模、求解和结果分析模板
- `scripts/05聚类与分类方法/Kmeans聚类全过程.py`: K-means聚类、K值选择、PCA可视化与聚类画像模板
- `scripts/05聚类与分类方法/分类流程全过程.py`: 分类建模、训练测试划分、评价指标、混淆矩阵与特征重要性模板
...
python scripts/02综合评价与权重方法/熵权法全过程.py
...
python scripts/05聚类与分类方法/分类流程全过程.py
git status
git add .
